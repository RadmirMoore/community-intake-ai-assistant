...
const CATEGORY_KEYWORDS: Record<Exclude<Category, "general">, string[]> = {
  ...
  housing: ["evict", "rent", "homeless", "shelter", "housing", "landlord", "utilities", "mortgage"],
  food: ["food", "hungry", "meal", "pantry", "grocery", "snap", "wic", "nutrition"],
  healthcare: ["health", "doctor", "clinic", "medicine", "medication", "insurance", "mental", "sick"],
  legal: ["legal", "lawyer", "court", "immigration", "custody", "rights", "attorney", "deport"],
};
